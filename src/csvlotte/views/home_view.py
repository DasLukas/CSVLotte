...
class HomeView(TranslationMixin):
    ...
    def _add_menu(self):
        ...
        hilfe_menu.add_command(label=self._get_text('manual'), command=self.controller.show_manual)
    ...
    def show_manual_window(self, html_content: str):
        """
        Show a window displaying the manual content as formatted HTML.
        """
